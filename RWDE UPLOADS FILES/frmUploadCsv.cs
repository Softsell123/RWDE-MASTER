...
namespace RWDE_UPLOADS_FILES
{
    public partial class frmUploadCsv : Form
    {
        ...
        public frmUploadCsv()//initializing of data
        {
            InitializeComponent();           
        ...
        private void btnNext_Click(object sender, EventArgs e)//to navigate to next page
        {
            ...
            frmHccCsv nextForm = new frmHccCsv();
        ...
        private void btnNext_Click_1(object sender, EventArgs e)//to navigate to next page
        {
            try { 
